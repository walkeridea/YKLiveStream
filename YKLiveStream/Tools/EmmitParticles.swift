...
func EmmitParticles(from point: CGPoint, emitter: CAEmitterLayer , in rootView:UIView) {
    ...
    rocket.emissionLongitude = CGFloat(Double.pi / 4)
    ...
    //UIColor(colorLiteralRed: 0.5, green: 0.5, blue: 0.5, alpha: 0.8).cgColor
    rocket.redRange = 0.5
    ...
    flare.emissionLongitude = 4 * CGFloat(Double.pi / 4)
    flare.scale = 0.4
    flare.velocity = 100;
    flare.birthRate = 45;
    flare.lifetime = 1.5;
    flare.yAcceleration = -350;
    flare.emissionRange = CGFloat(Double.pi / 4)
    ...
    firework.emissionRange = CGFloat(Double.pi / 4)
